...
export function exportToPPTX(data: CompanyData) {
    ...
    slide1.addText('Business Intelligence Deck (BID)', {
        x: 1,
        y: 3,
        fontSize: 28,
        color: '666666',
    ...
    slide2.addText(`Who are ${data.companyName}?`, {
        x: 0.5,
        y: 0.5,
        fontSize: 32,
        bold: true,
    ...
    slide4.addText('Corporate Structure', {
        x: 0.5,
        y: 0.5,
        fontSize: 28,
        bold: true,
    });
    const leadershipText = data.leadership
        .map((l) => `• ${l.name} – ${l.title}, ${l.background}`)
        .join('\n');
    slide4.addText(leadershipText, {
        x: 0.5,
        y: 1.0,
        fontSize: 14,
        valign: 'top',
    ...
    slide5.addText('Governance Structure', {
        x: 0.5,
        y: 0.5,
        fontSize: 28,
        bold: true,
    ...
    slide6.addText('Products/Services', {
        x: 0.5,
        y: 0.5,
        fontSize: 28,
        bold: true,
    ...
    slide8.addText('Financial Performance', {
        x: 0.5,
        y: 0.5,
        fontSize: 28,
        bold: true,
    ...
    slide11.addText('Improvement Opportunities', {
        x: 0.5,
        y: 0.5,
        fontSize: 28,
        bold: true,
    ...
    const col1Items = [
        ...
        ...data.improvements.costReduction.map((item) => ({
            text: item,
        ...
        ...data.improvements.portfolioOptimization.map((item) => ({
            text: item,
            options: { bullet: true, indentLevel: 0 },
        })),
        { text: '', options: { breakLine: true } }, // Empty line
        { text: 'Pricing & Revenue', options: { bold: true, breakLine: true } },
        ...data.improvements.pricingRevenue.map((item) => ({
            text: item,
            options: { bullet: true, indentLevel: 0 },
        })),
    ];
    ...
    const col2Items = [
        {
            text: 'Innovation & Brand Investment',
            options: { bold: true, breakLine: true },
        },
        ...data.improvements.innovation.map((item) => ({
            text: item,
            options: { bullet: true, indentLevel: 0 },
        })),
        { text: '', options: { breakLine: true } }, // Empty line
        {
            text: 'Integration Discipline',
            options: { bold: true, breakLine: true },
        },
        ...data.improvements.integrationDiscipline.map((item) => ({
            text: item,
            options: { bullet: true, indentLevel: 0 },
        })),
    ];
    ...
    slide12.addText('Pre-Meeting Analysis', {
        x: 0.5,
        y: 0.5,
        fontSize: 28,
        bold: true,
    ...
    slide12.addText(
        [
            ...
            ...data.analysis.preMeeting.dissatisfaction,
        ].join('\n'),
    ...
    slide13.addText('During Meeting Analysis', {
        x: 0.5,
        y: 0.5,
        fontSize: 28,
        bold: true,
    ...
    slide13.addText(
        [
            'Dissatisfaction Elements',
            ...data.analysis.duringMeeting.dissatisfaction,
        ].join('\n'),
        { x: 0.5, y: 1.5, fontSize: 14 }
    );
    slide13.addText(
    ...
    slide14.addText('Follow-up Actions', {
        x: 0.5,
        y: 0.5,
        fontSize: 28,
        bold: true,

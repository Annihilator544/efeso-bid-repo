...
export const CompanyDataSchema: Record<keyof CompanyData, FieldDefinition> = {
  ...
  overview: {
      ...
      required: ["description", "founded", "ownership", "employees", "reach", "businessModel"]
    },
    ...
    ownership: {
      ...
      required: ["currentOwner", "acquisitionDetails", "previousOwner", "managementContinuity"]
    },
    ...
    financials: {
      ...
      items: {
        ...
        required: ["year", "revenue", "operatingProfit", "netProfit", "operatingMargin", "freeCashFlow", "debt"]
      }
    },
    ...
    profitability: {
      ...
      required: ["annualRevenue", "operatingProfit", "netProfit", "operatingMargin", "netMargin"]
    },
    ...
    improvements: {
      ...
      required: ["costReduction", "portfolioOptimization", "pricingRevenue", "innovation", "integrationDiscipline"]
    },
    ...
    analysis: {
      ...
      properties: {
        preMeeting: {
          type: "object",
          properties: {
            dissatisfaction: { type: "array", items: { type: "string" } },

                    ...
                    <ul className='space-y-6 text-lg'>
                        ...
                        <li className='flex items-start gap-3'>
                            ...
                            <span>
                                ...
                                {data.ownership.previousOwner}
                            </span>
                        </li>
                        <li className='flex items-start gap-3'>
                            <div className='w-2 h-2 bg-efeso-orange rounded-full mt-3 flex-shrink-0'></div>
                            <span>
                                <strong>Management Continuity:</strong>{' '}
                                {data.ownership.managementContinuity}
                            </span>
                        </li>
                    </ul>
                </SlideLayout>
                                ...
                                {data.leadership.map((leader, index) => (
                                    ...
                                    >
                                        ...
                                        <span>
                                            ...
                                            {leader.title}, {leader.background}
                                        </span>
                                    </li>
                                ))}
                            </ul>
...

        {
            ...
            content: (
                ...
                >
                    <div className='space-y-8'>
                        <div>
                            <h3 className='text-xl font-semibold text-presentation-header mb-4'>
        ...
        // Slide 7: Geographic Operations
        {
            ...
            content: (
                ...
                >
                    <div className='space-y-6'>
                        <p className='text-lg text-gray-700'>
                            {data.companyName} has a strong manufacturing and
                ...
                >
                    <div className='space-y-6'>
                        ...
                        <PresentationTable
                            ...
                            rows={data.competitors.map((comp) => [
                                comp.name,
                                comp.focusAreas,
                            ])}
                        />
            ...
            content: (
                ...
                >
                    <div className='grid grid-cols-2 gap-8'>
                        <div className='space-y-6'>
                            <div>
                                <h3 className='text-lg font-semibold text-presentation-header mb-3'>
                                    Cost Reduction
                                </h3>
                ...
                <SlideLayout isTitle slideNumber={15} totalSlides={15}>
                    <div className='text-center space-y-12'>
                        ...
                        <div className='text-gray-500 mt-8'>
                            Driving operational excellence and sustainable
                            growth
                        </div>
                    </div>
                </SlideLayout>

  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Upload an Excel or CSV file with your company data. The file should contain questions and answers or structured data.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          ...
          >
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground">Supported formats: .xlsx, .xls, .csv</span>
            </div>
          </Button>
          ...
          <div className="text-sm text-muted-foreground">
            ...
            <p className="mt-2">
              For array data (leadership, products, etc.), separate multiple values with "|" in the answer column.
            </p>
          </div>
        </div>
      </CardContent>
